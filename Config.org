...
*** TODO Create presentation macros

(It should be a macro that makes the font larger, for instance, to be
used in livestreams or when doing some pair programming with other
people via screen sharing.)

** Themes, colors and fonts

Let's go with Tomorrow Theme.
